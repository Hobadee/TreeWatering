...
class treeWater:
        def __init__(self):
                ...
                self.GPIO_GND = []
                self.GPIO_GND.append(16)
                self.GPIO_GND.append(19)
                self.GPIO_GND.append(20)
                self.GPIO_GND.append(21)

                # Set several GPIOs as 3.3V to provide power
                self.GPIO_3v = []
                self.GPIO_3v.append(5)
                self.GPIO_3v.append(6)
                self.GPIO_3v.append(12)
                self.GPIO_3v.append(13)
